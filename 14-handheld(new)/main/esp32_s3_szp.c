/**
 * @file esp32_s3_szp.c
 * @brief 立创实战派 ESP32-S3 开发板 (SZP) 板级支持包实现
 *
 * 实现所有板载外设的初始化和驱动：
 * - I2C 总线初始化
 * - PCA9557 IO 扩展器驱动 (LCD_CS/PA_EN/DVP_PWDN)
 * - QMI8658 IMU 初始化和姿态读取
 * - ST7789 LCD + FT5x06 触摸 + LVGL 初始化
 * - I2S 音频通道 + ES8311/ES7210 编解码器初始化
 * - SPIFFS 文件系统挂载
 * - SD 卡挂载/卸载
 * - GC0308 摄像头初始化
 *
