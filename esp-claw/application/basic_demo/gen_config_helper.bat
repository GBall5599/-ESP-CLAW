...
E:\ESPIDF\551\Tools_551\python_env\idf5.5_py3.11_env\Scripts\python.exe %IDF_PATH%\tools\idf.py gen-bmgr-config -c ./boards -b esp32_s3_szp 2>&1
echo GEN_EXIT_CODE=%ERRORLEVEL%
